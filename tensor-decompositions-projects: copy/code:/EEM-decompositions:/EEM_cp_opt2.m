...
% use l = -inf (no lower bound) with a regularization of nu = 10^7.
...
nu = 10^7; % regularization parameter
...
% Plot 
figure('Name', 'Best CP-OPT Decomposition (l = -inf, nu = 10^7)');
for r = 1:R
    subplot(3, R, r);
    bar(A(:, r));
...
sgtitle('Best CP-OPT Decomposition (l = -inf, nu = 10^7)');
